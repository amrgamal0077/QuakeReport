...
public final class QueryUtils {
     ...
     */
    public static ArrayList<Earthquakeinfo> extractFeatureFromJson(String earthquakeJSON ) {
        ...
        try {
            ...
            for(int i=0 ; i< jsonArray.length();i++){
                ...
                Earthquakeinfo earthquakeinfo = new Earthquakeinfo(mag,properties.getString("place"),time,url);
    ...
    public static List<Earthquakeinfo> fetchEarthquakeData(String requestUrl) {
        ...
        List<Earthquakeinfo> earthquakes = extractFeatureFromJson(jsonResponse);
